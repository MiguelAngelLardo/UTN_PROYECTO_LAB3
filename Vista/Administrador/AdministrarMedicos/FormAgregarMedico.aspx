<%@ Page 
    Title="Agregar Medico" Language="C#" 
    MasterPageFile="~/Principal.Master"
    AutoEventWireup="true" CodeBehind="FormAgregarMedico.aspx.cs" 
    Inherits="Vista.Administrador.AdministrarMedicos.FormAgregarMedico" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">      
  <h2 class="titulo-pagina">Agregar médico</h2>
  ...
  <div class="contenedor-columnas">
    <div class="columna"><%-- Columna Izquierda--%>
      ...
      <asp:TextBox ID="txtLegajo" runat="server" CssClass="input-txtbox-form"></asp:TextBox>
      ...
      <asp:Label ID="lblCorreoElectronico" runat="server" Text="Correo Electrónico:"></asp:Label> <%-- Correo electrónico --%>
    ...
    <div class="columna"><%-- Columna dertecha --%>
      ...
      <asp:TextBox ID="txtDNI" runat="server" CssClass="input-txtbox-form"></asp:TextBox>
      ...
      <asp:CustomValidator ID="cvTel" runat="server" ControlToValidate="txtTelefono" ErrorMessage="-"  ClientValidationFunction="validarTelefono" Display="Static" CssClass="error-validacion" ValidateEmptyText="true"/> <%--sin el ValidateEmpty el custom o el regex validador no toma el "" o null

      <%-- Horarios --%>            
      <asp:Label ID="lblTurnoHorario" runat="server" Text="Turno:"></asp:Label>
    ...
    <div class="fila-boton-guardar"> 
       <asp:Button ID="btnGuardarMedico" CssClass="btnAgregar" runat="server" Text="Guardar" OnClick="btnGuardarMedico_Click"/>
