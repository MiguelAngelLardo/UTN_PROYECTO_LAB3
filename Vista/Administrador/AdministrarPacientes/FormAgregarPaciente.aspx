<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="FormAgregarPaciente.aspx.cs" Inherits="Vista.Administrador.AdministrarPacientes.FormAgregarPaciente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <h2 class="titulo-pagina">Agregar Paciente</h2> 
  <div class="contenedor-columnas">
    ...
    <div class="fila-mensajes">
        <asp:Label ID="lblMensajeError" runat="server" CssClass="mensaje-error" Visible="false" Text="Error"></asp:Label>
        <asp:Label ID="lblMensajeExito" runat="server" CssClass="mensaje-exito" Visible="false" Text="Éxito"></asp:Label>
    </div>
    
   <div class="fila-boton-guardar"> 
     <asp:Button ID="btnGuardar" CssClass="btnAgregar" runat="server" Text="Guardar" OnClick="btnGuardar_Click" />
